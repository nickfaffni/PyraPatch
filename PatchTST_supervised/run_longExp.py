...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='PyraPatch & PatchTST for Time Series Forecasting')

    # random seed
    parser.add_argument('--random_seed', type=int, default=2021, help='random seed')

    # PyraPatch
    parser.add_argument('--num_stages', type=int, default=1, help='number of pyramid stages (1=Baseline, 3=PyraPatch)')
